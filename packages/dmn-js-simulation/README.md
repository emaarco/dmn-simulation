...
![Simulating a DMN decision table — the input form runs the decision and highlights the matched rule](https://raw.githubusercontent.com/emaarco/dmn-js-simulation/main/docs/screenshots/simulation.png)
...
Contributions are welcome — see [CONTRIBUTING.md](https://github.com/emaarco/dmn-js-simulation/blob/main/CONTRIBUTING.md) for the monorepo layout, scripts, and how to build, test and run the example locally.
...
[MIT](https://github.com/emaarco/dmn-js-simulation/blob/main/LICENSE) © Marco Schäck
